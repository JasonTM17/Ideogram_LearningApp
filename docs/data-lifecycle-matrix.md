...
| `private.ai_tutor_conversations` / `private.ai_tutor_turns`                                                                                                                                                                                                                                                                | `user_id`, conversation/turn UUIDs   | Until privacy purge; no legal TTL claimed                         | Not yet exposed                         | AI cleanup trigger deletes by user in the purge transaction             | Stores bounded learner prompt and structured Vietnamese response; never direct client-readable                              |
