...
| `public.claim_placement_scoring_job`, `public.get_placement_scoring_input`, `public.complete_placement_scoring_job`, `public.fail_placement_scoring_job` | `service_role`              | Narrow PostgREST wrappers; learner roles are revoked                         | Implemented worker RPC     |
